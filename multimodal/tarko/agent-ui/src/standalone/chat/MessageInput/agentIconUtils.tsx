...
export const getAgentOptionIcon = (
  ...
  if (lowerKey.includes('browser') || lowerTitle.includes('browser'))
    return <TbBrowser className={className} />;
  if (lowerKey.includes('search')) return <TbSearch className={className} />;
  if (lowerKey.includes('research')) return <TbBook className={className} />;
  if (lowerKey.includes('foo')) return <TbBulb className={className} />;
